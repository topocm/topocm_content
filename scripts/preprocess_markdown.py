...
FULL_TEMPLATE = Template("""{{preprint.title}} ([arXiv:{{preprint.id}}](https://arxiv.org/abs/{{preprint.id}}))

{{preprint.authors | join(', ')}}

> {{preprint.abstract}}""")
SHORT_TEMPLATE = Template("""**{{preprint.title}}** ([arXiv:{{preprint.id}}](https://arxiv.org/abs/{{preprint.id}}))
  {{preprint.authors | join(', ')}}"""
)
