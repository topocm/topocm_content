...
The Anderson model is just the simplest [tight-binding model on a square lattice](https://kwant-project.org/doc/1.0/tutorial/tutorial1) with random onsite potential.
